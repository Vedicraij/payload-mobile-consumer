...
export const ReservationsScreen = () => <View style={styles.container}><Text style={styles.eyebrow}>Casa Maiz</Text><Text accessibilityRole="header" style={styles.title}>Your table is waiting.</Text><Text style={styles.body}>This demo keeps the reservation provider external. The CMS controls this entry point and its availability.</Text><Pressable accessibilityRole="button" style={styles.button}><Text style={styles.buttonText}>Find a table</Text></Pressable></View>;
